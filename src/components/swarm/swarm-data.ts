...
export type TemplateId =
  | "x-thread" | "market-maker" | "reddit-narrative"
  | "polymarket" | "research-swarm" | "ops" | "custom";
...
export interface SwarmEventItem { id: string; title: string; body: string; meta?: string; tone?: "bear" | "bull" | "neutral"; level?: "info" | "warn" | "error" | "fatal"; }
...
export interface SwarmTemplate { id: TemplateId; label: string; kind: string; agents: number; desc: string; }
