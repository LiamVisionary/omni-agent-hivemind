...
export default function DashboardApp({ initialView }: DashboardAppProps = {}) {
  ...
  const [vaultPanelMode, setVaultPanelMode] = useState<"hive-vault" | "shared-skills" | "config">("hive-vault");
